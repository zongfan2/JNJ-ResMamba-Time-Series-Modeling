...
# script resolves it to experiments/configs/deep_scratch/ablation/ablation_<variant>.yaml
...
#
# Usage (from Domino):
#   bash /mnt/code/munge/predictive_modeling/code/JNJ-ResMamba-Time-Series-Modeling/experiments/deep_scratch/run_ablation.sh <variant>
#
# Variants:
