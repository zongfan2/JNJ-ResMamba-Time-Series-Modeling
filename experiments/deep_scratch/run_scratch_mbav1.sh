...
#
# Usage (from Domino):
#   bash /mnt/code/munge/predictive_modeling/code/JNJ-ResMamba-Time-Series-Modeling/experiments/deep_scratch/run_scratch_mbav1.sh
#
# CLI args can override YAML values:
#   bash experiments/deep_scratch/run_scratch_mbav1.sh experiments/configs/deep_scratch/scratch_baseline.yaml --epochs 100

set -euo pipefail

ROOT_DIR="/mnt/code/munge/predictive_modeling/code/JNJ-ResMamba-Time-Series-Modeling"
CONFIG="${1:-${ROOT_DIR}/experiments/configs/deep_scratch/scratch_mbav1_deepscratch.yaml}"
