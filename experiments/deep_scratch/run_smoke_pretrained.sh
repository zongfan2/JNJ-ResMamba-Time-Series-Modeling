...
#
# Usage (from Domino):
#   bash /mnt/code/munge/predictive_modeling/code/JNJ-ResMamba-Time-Series-Modeling/experiments/deep_scratch/run_smoke_pretrained.sh
#
...
python3.11 "${ROOT_DIR}/training/train_scratch.py" \
    --config "${ROOT_DIR}/experiments/configs/deep_scratch/smoke_pretrained_mbav1.yaml" \
    "$@"
