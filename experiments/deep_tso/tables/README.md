...
bash experiments/deep_tso/deep_tso_setup.sh         # deps, once
...
`experiments/deep_tso/build_deep_tso_h5.sh`. Confirm UKB is populated and multi-night with
...
Full per-experiment design rationale: `docs/deep_tso/experiment_plan.md`.
