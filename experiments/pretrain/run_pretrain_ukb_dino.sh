...
#
# Usage (from Domino):
#   bash /mnt/code/munge/predictive_modeling/code/JNJ-ResMamba-Time-Series-Modeling/experiments/pretrain/run_pretrain_ukb_dino.sh
...
python3.11 "${ROOT_DIR}/training/pretrain_ukb.py" \
    --config "${ROOT_DIR}/experiments/configs/pretrain/pretrain_ukb_dino.yaml" \
    "$@"
