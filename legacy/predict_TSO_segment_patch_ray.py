...
#     training/train_tso_patch.py  (no Ray-specific replacement; use the non-Ray patch trainer or contact maintainers if Ray-distributed inference is still needed)
#
